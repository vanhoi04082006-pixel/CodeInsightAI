...
//   src/lib/analyzers/security.ts     — 13 core + 74 extra = 87 rule checks
//   src/lib/analyzers/bugs.ts         — 11 core + 59 extra = 70 rule checks
//   src/lib/analyzers/performance.ts  — 42 core + 38 extra = 80 rule checks
//   Total: 237 static analysis rules
//
...
export const STATIC_RULES_TOTAL =
  STATIC_RULES_SECURITY + STATIC_RULES_BUGS + STATIC_RULES_PERFORMANCE; // 237
