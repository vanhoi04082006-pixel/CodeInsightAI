...
export const metadata: Metadata = {
  ...
  description:
    `AI-powered GitHub repository analysis platform. ${STATIC_RULES_TOTAL} static rules + ${ANALYSIS_PASSES.length}-pass AI deep analysis. CodeGraph, AI Chat. BYOK free or Platform AI $9/mo.`,
  keywords: [
    "CodeInsight AI",
    "GitHub analysis",
    "AI code review",
  ...
  openGraph: {
    ...
    description: `Analyze any GitHub repo with ${STATIC_RULES_TOTAL} static rules + ${ANALYSIS_PASSES.length}-pass AI deep analysis. CodeGraph visualization, AI chat.`,
  ...
  return (
    <html lang={initialLocale} data-scroll-behavior="smooth" suppressHydrationWarning>
      ...
      >
        ...
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[200] focus:rounded-lg focus:bg-cyan-500 focus:px-4 focus:py-2 focus:text-white">
          Skip to content
        </a>
